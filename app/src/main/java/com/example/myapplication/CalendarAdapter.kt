...
class CalendarAdapter(
    ...
    private val trainingDay : TrainingDay = TrainingDay(Color.rgb(41,46,74), Color.rgb(70,81,194))
    private val currentDay : CurrentDay = CurrentDay(Color.rgb(70,81,194), Color.rgb(255,255,255))
